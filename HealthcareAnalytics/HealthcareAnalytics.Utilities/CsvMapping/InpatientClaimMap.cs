...
namespace HealthcareAnalytics.Utilities.CsvMapping
{
    public sealed class InpatientClaimMap : CsvClassMap<InpatientClaim>
    {
        public InpatientClaimMap()
        {
            ...
            Map(c => c.ClaimsStartDate).Name("CLM_FROM_DT").TypeConverter<LocalDateTypeConverter>();
            Map(c => c.ClaimsEndDate).Name("CLM_THRU_DT").TypeConverter<LocalDateTypeConverter>();
            ...
            Map(c => c.InpatientAdmissionDate).Name("CLM_ADMSN_DT").TypeConverter<LocalDateTypeConverter>();
            ...
            Map(c => c.InpatientDischargedDate).Name("NCH_BENE_DSCHRG_DT").TypeConverter<LocalDateTypeConverter>();
